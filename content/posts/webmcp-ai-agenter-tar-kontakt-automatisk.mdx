---
title: "WebMCP: Slik kan AI-agenter ta kontakt automatisk"
...
slug: "webmcp-ai-agenter-tar-kontakt-automatisk"
publishedAt: "2026-07-30"
author: "Puzl"
tags: ["WebMCP", "AI-agenter", "Tilnærming"]
faq:
  - question: "Hva er WebMCP?"
    answer: "En teknologi som lar en nettside fortelle en AI nøyaktig hvilke handlinger som er mulige på siden, og hvordan de skal brukes, slik at en AI kan handle på vegne av brukeren direkte i samtalen, i stedet for bare å lese siden slik et menneske ville gjort."
  - question: "Hva er forskjellen på MCP og WebMCP?"
    answer: "MCP er den generelle standarden for hvordan en AI bruker verktøy. WebMCP tar den samme idéen og flytter den inn i nettleseren, direkte på selve nettsiden, slik at nettsiden selv kan tilby verktøy til AI-agenter som besøker den."
  - question: "Må kunden laste ned noe eller opprette en konto for at WebMCP skal fungere?"
    answer: "Nei. Kunden fortsetter bare samtalen de allerede har med AI-en sin. Nettsiden blir i praksis en dør AI-en kan gå gjennom, ikke noe brukeren selv må sette opp."
  - question: "Er WebMCP bare nyttig for bedrifter med kontaktskjema?"
    answer: "Nei. Mønsteret gjelder uansett bransje. En frisørsalong kan la AI-en booke timer, en eiendomsmegler kan la AI-en sende visningsforespørsler, en nettbutikk kan la AI-en sjekke lagerstatus og legge varer i handlekurven."
  - question: "Hvor utbredt er WebMCP akkurat nå?"
    answer: "Fortsatt svært tidlig. Nesten ingen nettsider i verden har tatt det i bruk ennå, noe som gjør det til et av de sjeldne tilfellene der man faktisk kan ligge foran i stedet for bare å henge med."
  - question: "Hvordan vet man at WebMCP faktisk fungerer i praksis?"
    answer: "Ved å teste det selv. Puzl har bygget WebMCP på egen side med fire verktøy en AI-agent kan bruke direkte, og styrer det med samme domenekompetanse som resten av det som leveres."
---
